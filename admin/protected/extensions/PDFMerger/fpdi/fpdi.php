...
if (class_exists(dirname(__FILE__).'\/protected\/extensions\/PDFMerger\/'.'TCPDF')) {
    require_once(dirname(__FILE__).'\/protected\/extensions\/PDFMerger\/'.'fpdi2tcpdf_bridge.php');
}
