...
/**
 * This is the model class for table "mdstdstestbasedetails".
 *
 * The followings are the available columns in table 'mdstdstestbasedetails':
 * @property string $Id
 ...
 * @property Testbasicparams $p
 */
class Mdstdstestbasedetails extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'p' => array(self::BELONGS_TO, 'Testbasicparams', 'PID'),
		);
	}
	 ...
	 * @return Mdstdstestbasedetails the static model class
	 */
