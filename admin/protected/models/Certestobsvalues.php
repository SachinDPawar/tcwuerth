...
/**
 * This is the model class for table "certestobsvalues".
 *
 * The followings are the available columns in table 'certestobsvalues':
 * @property string $Id
 ...
 */
class Certestobsvalues extends CActiveRecord
{
	/**
	 ...
	 * @return Certestobsvalues the static model class
	 */
