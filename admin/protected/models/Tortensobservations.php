...
/**
 * This is the model class for table "tortensobservations".
 *
 * The followings are the available columns in table 'tortensobservations':
 * @property string $Id
 ...
 */
class Tortensobservations extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, RirTestId, Torque, Force, Coff_Friction, Status, SeqNo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Tortensobservations the static model class
	 */
