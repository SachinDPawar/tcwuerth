...
/**
 * This is the model class for table "certmicroexamination".
 *
 * The followings are the available columns in table 'certmicroexamination':
 * @property string $Id
 ...
 */
class Certmicroexamination extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('BatchCode', 'length', 'max'=>100),
			array('Remark', 'length', 'max'=>150),
			array('Parameter, Required, Observation, CreationDate, LastModified', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, SeqNo, BatchCode, Parameter, Required, Observation, Remark, CreationDate, LastModified, ModifiedBy, CSID', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Certmicroexamination the static model class
	 */
