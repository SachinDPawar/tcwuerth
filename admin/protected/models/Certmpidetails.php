...
/**
 * This is the model class for table "certmpidetails".
 *
 * The followings are the available columns in table 'certmpidetails':
 * @property string $Id
 ...
 */
class Certmpidetails extends CActiveRecord
{
	/**
	 ...
	 * @return Certmpidetails the static model class
	 */
