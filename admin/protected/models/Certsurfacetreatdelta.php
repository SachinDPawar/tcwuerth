...
/**
 * This is the model class for table "certsurfacetreatdelta".
 *
 * The followings are the available columns in table 'certsurfacetreatdelta':
 * @property string $Id
 ...
 */
class Certsurfacetreatdelta extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Type, CSID', 'required'),
			array('Type, SeqNo, CoatMin, CoatMax, SaltMin, SaltMax, ModifiedBy, CSID', 'length', 'max'=>20),
			...
			array('Id, Type, SeqNo, CoatMin, CoatMax, SaltMin, SaltMax, AdhesionReq, VisualReq, Observations, CoatRemark, SaltRemark, AdhesionRemark, VisualRemark, CreationDate, LastModified, ModifiedBy, CSID', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Certsurfacetreatdelta the static model class
	 */
