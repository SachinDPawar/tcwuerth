...
/**
 * This is the model class for table "certwobservations".
 *
 * The followings are the available columns in table 'certwobservations':
 * @property string $Id
 ...
 */
class Certwobservations extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('RequiredTS, ObservedTS', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, CertTestId, LabNo, TestId, SeqNo, HeatNo, BatchCode, Remark, ShowInCert, LastModified, RequiredTS, ObservedTS', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Certwobservations the static model class
	 */
