...
/**
 * This is the model class for table "mdstdstestdetails".
 *
 * The followings are the available columns in table 'mdstdstestdetails':
 * @property string $Id
 ...
 */
class Mdstdstestdetails extends CActiveRecord
{
	/**
	 ...
	 * @return Mdstdstestdetails the static model class
	 */
