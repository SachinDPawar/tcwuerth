...
/**
 * This is the model class for table "certnondestructive".
 *
 * The followings are the available columns in table 'certnondestructive':
 * @property string $Id
 ...
 */
class Certnondestructive extends CActiveRecord
{
	/**
	 ...
	 * @return Certnondestructive the static model class
	 */
