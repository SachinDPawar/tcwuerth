...
/**
 * This is the model class for table "certnonmetallic".
 *
 * The followings are the available columns in table 'certnonmetallic':
 * @property string $Id
 ...
 */
class Certnonmetallic extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('HeatNo', 'length', 'max'=>100),
			array('Remark', 'length', 'max'=>150),
			array('Parameter, Required, Observation, CreationDate, LastModified', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, SeqNo, HeatNo, Parameter, Required, Observation, Remark, CreationDate, LastModified, ModifiedBy, CSID', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Certnonmetallic the static model class
	 */
