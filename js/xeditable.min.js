...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs4': {
      ...
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn  btn-sm btn-primary"><span></span></button>',
      cancelTpl:   '<button type="button" class="btn btn-sm  btn-secondary" ng-click="$form.$cancel()">'+
                     '<span></span>'+
                   '</button>',
      resetTpl:    '<button type="reset" class="btn btn-sm btn-danger">clear</button>',
      ...
      buttonGroupAppendClass: 'input-group-text',
      postrender: function() {
          //apply `form-control` class to std inputs
          switch(this.directiveName) {
              case 'editableText':
