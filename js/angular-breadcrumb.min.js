...
function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
    var $$templates = {
        bootstrap2: '<ul class="list-group list-group-horizontal">' +
            ...
            '</li>' +
            '</ul>',
        bootstrap3: '<ul class="float-start list-group list-group-horizontal breadcrumb">' +
            '<li ng-repeat="step in steps" class="list-group-item breadcrumb__item" ng-class="{active: $last}" ng-switch="$last || !!step.abstract">' +
            '<span class="breadcrumb__inner"><a ng-switch-when="false" href="{{step.ncyBreadcrumbLink}}"><span class="breadcrumb__title">{{step.ncyBreadcrumbLabel}}</span></a>' +
            '<span ng-switch-when="true"><span class="breadcrumb__title">{{step.ncyBreadcrumbLabel}}</span></span> </span>' +
            '</li>' +
            '</ull>'
    };
